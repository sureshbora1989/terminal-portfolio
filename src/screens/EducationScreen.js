...
const data = [
  {
    type: "Compaines worked till now",
    skillsList: [
      "Denave India Private LTD - Present",
      "Logical Flip",
      "Alignminds Technologes Pvt LTD"
    ]
  },
  {
    type: "Academic background",
    skillsList: ["B.Tech in Computer Science"]
  }
];
  ...
  return (
    <View style={styles.container}>
      <View style={styles.contentContainer}>
        <Text style={styles.headingMain}>Education</Text>
        <FlatList
